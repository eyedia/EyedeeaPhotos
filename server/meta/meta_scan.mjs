...
export function save_item(json_data) {
    return new Promise((resolve, reject) => {
        ...
        meta_db.run(
            insert_query,
            [json_data.source_id, json_data.photo_id, json_data.filename, json_data.folder_id, json_data.folder_name, json_data.time, json_data.type, json_data.orientation, json_data.cache_key, json_data.unit_id, json_data.persons, json_data.geocoding_id, json_data.tags, json_data.address],
            function (err) {
                if (err) {
