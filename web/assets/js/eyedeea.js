...
/* Following functions try keeping the device active, when running on Fire TV/Android  */
...
(function() {
    ...
    setInterval(function() {
        if (document.visibilityState === 'visible') {
            ...
            try {
                ...
                // TouchEvent may not be constructable in some browsers/contexts
            }
    ...
    async function requestWakeLock() {
        try {
            ...
            console.log('Wake Lock error:', err && err.message ? err.message : err);
        }
    }
    ...
    console.log('Keep-awake script injected successfully');
})();
